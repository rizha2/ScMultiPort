...
GitUser="rizha2"
#Open HTTP Puncher By NASZURTECHVPN  
...
cd 
wget -O /usr/local/bin/ohp "https://raw.githubusercontent.com/${GitUser}/rizha2/main/ohp"
...
[Unit]
Description=Direct Squid Proxy For OpenVPN TCP By NASZURTECH
