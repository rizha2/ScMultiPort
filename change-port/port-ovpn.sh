...
############## WELCOME TO NASZURTECHVPN ###############
############## By NASZURTECH ###############
setenv FRIENDLY_NAME "NASZURTECH PREMIUM TCP"
client
dev tun
proto tcp
remote $domain 1194
...
############## WELCOME TO NASZURTECHVPN ###############
############## By NASZURTECH ###############
setenv FRIENDLY_NAME "NASZURTECH PREMIUM UDP"
client
dev tun
proto udp
remote $domain 2200
...
setenv FRIENDLY_NAME "NASZURTECH PREMIUM OHP"
http-proxy $MYIP $vpn
...
[Unit]
Description=Direct Squid Proxy For OpenVPN TCP By NASZURTECHVPN
Documentation=https://t.me/mastar27g
...
############## WELCOME TO NASZURTECHVPN ###############
############## BY NASZURTECH ###############
setenv FRIENDLY_NAME "NASZURTECH PREMIUM SSL"
client
dev tun
proto tcp
remote $domain $vpn
